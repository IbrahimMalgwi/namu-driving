...
const fixedContent = [
    ...
    },
    {
        ...
        sign_visual: { shape: "octagon", label: "STOP" },
        package_type: "all",
        is_fixed: true,
    },
    {
        ...
        sign_visual: { shape: "no_parking", label: "P" },
        package_type: "all",
        is_fixed: true,
    },
    {
        id: "fixed-road-sign-3",
        type: "road_sign",
        title: "Pedestrian Crossing",
        body: "Slow down and watch for people crossing. Stop when pedestrians are already on the crossing or about to enter it.",
        sign_visual: { shape: "warning", label: "🚶" },
        package_type: "all",
        is_fixed: true,
    },
    {
        id: "fixed-road-sign-4",
        type: "road_sign",
        title: "Speed Limit",
        body: "Do not drive faster than the displayed limit. Adjust your speed lower when traffic, weather, or road conditions are unsafe.",
        sign_visual: { shape: "speed_limit", label: "50" },
        package_type: "all",
        is_fixed: true,
    },
    {
